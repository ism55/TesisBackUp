...
Desde Robocom se puede enviar una rutina default para configuración previa de la posición de cada motor. Esto se logra presionando la pestaña 'Posiciones por defecto' que se observa en la figura \ref{fig:robocomopen}(1).
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{img/docklight}
