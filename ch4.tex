...
\begin{figure}[H]
	...
	\caption{Tarjeta del convertidor USB/Serial FTDI232 incluida en la unidad controladora.}
	\label{fig:ftdi}
\end{figure}
...
\begin{figure}[H]
	...
	\caption[onfiguración de constantes de calibració]{Configuración de constantes de calibración del software Robocom}
