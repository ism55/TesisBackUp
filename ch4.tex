...
\begin{figure}[H]
		\begin{minipage}[c]{0.3\textwidth}
			\centering
			\includegraphics[scale=0.1]{img/q1_grado_0}
	\end{minipage}
	\hfill 	
		\begin{minipage}[c]{0.3\textwidth}
			\centering
			\includegraphics[scale=0.1]{img/q1_grado_+135}
	\end{minipage}
	\hfill	
		\begin{minipage}[c]{0.3\textwidth}
			\centering
...
\begin{figure}[H]
	\begin{minipage}[c]{0.3\textwidth}
		\centering
		\includegraphics[scale=0.1]{img/q2_grado_0}
	\end{minipage}
	\hfill 	
	\begin{minipage}[c]{0.3\textwidth}
		\centering
		\includegraphics[scale=0.1]{img/q2_grado_+135}
	\end{minipage}
	\hfill	
	\begin{minipage}[c]{0.3\textwidth}
		\centering
...
\begin{figure}[H]
	\begin{minipage}[c]{0.3\textwidth}
		\centering
		\includegraphics[scale=0.1]{img/q3_grado_0}
	\end{minipage}
	\hfill 	
	\begin{minipage}[c]{0.3\textwidth}
		\centering
		\includegraphics[scale=0.1]{img/q3_grado_+135}
	\end{minipage}
	\hfill	
	\begin{minipage}[c]{0.3\textwidth}
		\centering
...
\begin{figure}[H]
	\begin{minipage}[c]{0.3\textwidth}
		\centering
		\includegraphics[scale=0.1]{img/q4_grado_0}
	\end{minipage}
	\hfill 	
	\begin{minipage}[c]{0.3\textwidth}
		\centering
		\includegraphics[scale=0.1]{img/q4_grado_+66}
	\end{minipage}
	\hfill	
	\begin{minipage}[c]{0.3\textwidth}
		\centering
...
\begin{figure}[H]
	\begin{minipage}[c]{0.3\textwidth}
		\centering
		\includegraphics[scale=0.1]{img/q5_grado_0}
	\end{minipage}
	\hfill 	
	\begin{minipage}[c]{0.3\textwidth}
		\centering
		\includegraphics[scale=0.1]{img/q5_grado_+60}
	\end{minipage}
	\hfill	
	\begin{minipage}[c]{0.3\textwidth}
		\centering
		\includegraphics[scale=0.1]{img/q5_grado_-66}
	\end{minipage}
...
\begin{figure}[H]
	\begin{minipage}[c]{0.3\textwidth}
		\centering
		\includegraphics[scale=0.1]{img/q6_grado_0}
	\end{minipage}
	\hfill 	
	\begin{minipage}[c]{0.3\textwidth}
		\centering
		\includegraphics[scale=0.1]{img/q6_grado_+66}
	\end{minipage}
	\hfill	
	\begin{minipage}[c]{0.3\textwidth}
		\centering
