...
En [1] se describe cada uno de los seis grados de libertad del brazo manipulador como una unión que permite al robot doblar, rotar o trasladar la parte móvil de este. Así como lo muestra la figura \ref{fig:dof}, donde cada grado de libertad está identificado y relacionado con una parte del cuerpo humano.

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{img/DOF}
	\caption{Estructura básica de un brazo robótico. Fuente: [1]}
	\label{fig:dof}
\end{figure}
...
Ha sido muy utilizado en el campo de la medicina, ya que una característica importante de este sistema es que cuenta con un marco que le permite una mayor precisión y rapidez en los movimientos. Según se menciona en \citep{miller2009anesthesia}, este cuenta con la aceptación de su uso para fines médicos.
