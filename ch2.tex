...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.3]{img/canadarm1}
	\caption{Canadarm 1}
	\label{fig:canadarm1}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.3]{img/canadarm2}
	\caption{Canadarm 2}
	\label{fig:canadarm2}
\end{figure}
...
Se trata de un robot de seis grados de libertad y un elemento final de control controlado por control remoto. El primer modelo, el Canadarm, operó durante treinta años en la Estación Espacial Internacional y fue conocido también con el nombre Shuttle Remote Manipulator System (SRMS).  


Este robot fabricado en Canadá, es utilizado en la estación espacial.
