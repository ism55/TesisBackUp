...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{img/chart}
	\caption{Comparación entre los dispositivos considerados}
	\label{fig:arana}
\end{figure}

Para entender el gráfico de la figura \ref{fig:arana}, se describe la siguiente leyenda:

\begin{description}
	\item[Conectividad Wi-Fi] 
	
	1: Posee conectividad Wi-Fi. 
	\\ 0: No posee conectividad Wi-Fi
	
	\item[RTOS]
	
	0: No posee conectividad Wi-Fi\\
	1: Puede implementarse RTOS\\
	0: No puede implementarse RTOS\\

	\item[Lenguaje C]
	
	1: Puede programarse en C\\
	0: No puede programarse en C
	...
	\item[Capacidad de Memoria (MB)]
	
	1: Menor o igual a 10MB\\
	2: Entre 10MB y 100MB\\
	3: De 100MB en adelante\\
...
Otro factor importante para la selección de este dispositivo es la relación de costo-benecifio que se consigue con la adquisición de este módulo. Ya que puede igualar parte del alcance de dispositivos de mayor gama tecnológica a un costo considerablemente reducido. 
