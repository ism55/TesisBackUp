...
\begin{table}
	\begin{tabular}{|c|l|}
		\hline
		\multicolumn{ 1}{|c|}{RTOS} & 0: No posee conectividad Wi-Fi \\
		\hline
		\multicolumn{ 1}{|c|}{} & 1: Puede implementarse RTOS \\
		\hline
		\multicolumn{ 1}{|c|}{} & 0: No puede implementarse RTOS \\
		\hline
		\multicolumn{ 1}{|c|}{Lenguaje C} & 1: Puede programarse en C \\
		\hline
		\multicolumn{ 1}{|c|}{} & 0: No puede programarse en C \\
		\hline
		\multicolumn{ 1}{|c|}{Costo (\$} & 1: Menor o igual a 5\$ \\
		\hline
		\multicolumn{ 1}{|c|}{} & 2: Entre 5\$ y 20\$ \\
		\hline
		\multicolumn{ 1}{|c|}{} & 3: Mayor a 20\$ \\
		\hline
		\multicolumn{ 1}{|c|}{Capacidad de Memoria (MB)} & 1: Menor o igual a 10MB \\
		\hline
		\multicolumn{ 1}{|c|}{} & 2: Entre 10MB y 100MB \\
		\hline
		\multicolumn{ 1}{|c|}{} & 3: De 100MB en adelante \\
		\hline
		\multicolumn{ 1}{|c|}{UART} &  1: 1 UART \\
		\hline
		\multicolumn{ 1}{|c|}{} &  2: 2 UART \\
		\hline
		\multicolumn{ 1}{|c|}{} & 3: 3 o más UART \\
		\hline
		\multicolumn{ 1}{|c|}{GPIO} & 1: Menos de 20 \\
		\hline
		\multicolumn{ 1}{|c|}{} & 2: Entre 20 y 30 \\
		\hline
		\multicolumn{ 1}{|c|}{} & 3: 30 o más \\
		\hline
		\end{tabular}  
...
Por las características observadas en la figura \ref{fig:arana}, además de las dificultades de conectividad a internet, la posibilidad de conexión a diversos dispositivos, y las ventajas de la utilización de la tecnología Wi-Fi antes que Bluetooth como se muestra en la tabla \ref{TAB:comparacionbtwf}, se seleccionará el dispositivo ESP-8266 con conectividad Wi-Fi sin acceso a internet para establecer un servidor de comunicación con una página web incluida en el SoC el cuál podrá accederse de forma remota para lograr el movimiento del brazo robot sin presencia de computadores intermediarios.
