...
\begin{figure}[H]
	\centering
	{\includegraphics[scale=0.9]{img/kyl}\label{fig:kyl}}
	
	\caption{KYL-500S. Fuente: Shenzen KYL Communication Equipment Co., Ltd.}
	
\end{figure}

\begin{figure}[H]
	\centering
	{\includegraphics[scale=0.4]{img/modulorf}\label{fig:modulorf}}
	\caption{nRF24L01. Fuente: Nordic Semiconductor.}
