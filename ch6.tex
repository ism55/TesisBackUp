En este capítulo se describirán el software y hardware empleados para la programación del firmware de la tarjeta de desarrollo seleccionada para el prototipo. Además, se mostrarán los resultados alcanzados durante este proceso.
...
En el caso del Espressif NON OS ESP-8266 SDK, se trata de un kit diseñado por la empresa Espressif para desarrollar software en dispositivos sin sistema operativo. En ella tiene las librerías de mayor importancia para la configuración y uso del ESP-8266. \cite{esp1} \cite{esp2} \cite{esp3} \cite{esp4} 
...
Posee los macros y variables necesarias para la configuración del UART.
