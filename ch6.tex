...
Una vez obtenido ese valor, este es convertido en entero con la función atoi de la librería stdlib.h o convertido en float con la función atof (o en su defecto, la función personalizada myatof). Seguidamente, se aplica la conversión según la expresión \ref{ec:convertirdigital} obtenida de la ecuación \ref{ec:convertiragrados}.
