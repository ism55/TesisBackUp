...
Hecho esto, se podrá programar el microcontrolador en lenguaje C a través del IDE Atom PlatformIO. Compilando y cargando el programa como se muestra en la figura \ref{fig:atom4}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.3]{img/atom_4}
	\caption{Compilación y carga del programa en la tarjeta.}
	{1. Compilar programa.\\
...
En cuanto al diseño de la página web; se desarrolló este código a través del editor de texto Brackets versión 1.14, ya que este trae soporte en tiempo real para modificaciones del archivo HTML y los diversos scripts. Las versiones de software utilizadas para esta sección se encuentras indicadas en la tabla \ref{TAB:paginaweb}. 

Posteriormente, el código fuente generado para la página web, observado en la figura \ref{fig:pagina1},  fue agregado al programa del sistema embebido como una cadena de caracteres, generando una página inicial para el servidor que se establecerá. 
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{img/pagina_1}
	\caption{Vista del software Brackets para el diseño de la página web.}
	\label{fig:pagina1}
\end{figure}
...
La aplicación basada en el SDK de Android fue desarrollada en el entorno de programación Android Studio en lenguaje Java. Esta información está resumida en la tabla \ref{TAB:android}. 
