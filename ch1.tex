...
En MES de 2018, Alexis Labrador presentó un trabajo de grado titulado "Diseño de un equipo para el control y monitoreo de un motor asincrónico usando una aplicación móvil" en la Universidad Central de Venezuela.\cite{alexis1}
...
Jorge Valderrama presentó el trabajo de grado titulado "Diseño de un conjunto de prácticas para la configuración y uso básico del microcontrolador ESP8266" en la Universidad Central de Venezuela, en el mes de MES de 2018.
