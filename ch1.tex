...
\subsubsection{{Breve introducción al capítulo}}

En este capítulo se expondrá el problema que motiva a la investigación de este trabajo, considerando un brazo manipulador ubicado en las instalaciones del Laboratorio de Control, Investigación y Desarrollo (LCID) dentro de la Universidad Central de Venezuela. Para alcanzar el objetivo general, se establecen objetivos específicos como: documentar técnicas y metodologías, determinar las acciones del brazo manipulador, seleccionar y diseñar el sistema remoto que se propondrá en los capítulos siguientes. Como justificación, se indica que el producto de este trabajo permitirá reforzar conocimientos en el área de sistemas automáticos de control; por lo que es siempre importante realizar mejoras en el diseño original.
