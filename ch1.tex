...
Este equipo permitirá reforzar conocimientos en el área de sistemas automáticos de control. Siendo este manipulador un diseño enfocado como equipo de laboratorio en la Escuela de Ingeniería Eléctrica (EIE)\citep{juan1}, es siempre importante una propuesta para mejorar la utilidad del mismo utilizando nuevas tecnologías relacionadas con accesos remotos.
